...
### source/exceptions
* Для хранения пользовательских классов исключений.

### source/locales
* Здесь должна храниться логика локализации бота.

### source/misc
* Подразумевается, что в ней будут храниться вспомогательные функции и конфигурации.

### source/models
* Директория предназначена для создания различных моделей БД (базы данных).

### source/services
* Здесь должны храниться различные сервисы (например логика каких-то доп. библиотек).

### source/telegram
* Основная директория, которая должна хранить в себе всю логику бота (хендлеры, каллбеки и т.д.).

### source/telegram/filters
* Подразумевается, что в ней будут фильтры обработки сообщений.

### source/telegram/handlers
* Директория предназначена для обработчиков команд и сообщений.

### source/telegram/keyboards
* Для создания и хранения клавиатур.
